			...
			renderItem={item => (
				<List.Item>
					...
					<div className={'content-info'}>
						<span className={'date'}><CalendarOutlined style={{color:"#1890ff"}}/> 2020-10-11</span>
						<span className={'type'}><FileOutlined style={{color:'#6c6c6c'}}/> 图文</span>
						<span className={'watch-number'}><FireOutlined style={{color:'#ff4d4f'}}/>2000</span>
					</div>
